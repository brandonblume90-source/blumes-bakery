export const FEATURED_ITEMS = [
  {
    id: 1,
    slug: "og-chocolate-chip-cookies",
    name: "OG Chocolate Chip Cookies",
    price: "$5.00 / each",
    priceOptions: [
...
export const REVIEWS = [
  {
    id: 1,
    text: "Emily's cinnamon rolls are probably the best cinnamon rolls I have had. They were a big hit at the bridal shower I got them for. I would love to order them again sometime!!! I also got the cookie butter cookies. ORDER THESE!!!! 🤤🤤🤤🤤",
    author: "Ashley",
  },
  {
    id: 2,
    text: "I ordered cookies from Blume's Bakery, and they were absolutely delicious! I couldn't get enough and will definitely be ordering more soon. The process was smooth and easy, and she was very accommodating with pick-up times. Overall, it was a wonderful experience—thank you!",
    author: "Renee",
  },
  {
    id: 3,
    text: "Blume's Bakery cookies are the best! ⭐⭐⭐⭐⭐",
    author: "Jade",
  }
];
